...
const PropertyDetailsPage: React.FC = () => {
  ...
  useSEO({
    ...
    description: property
      ...
      : 'View property details on Crespo Real Estate.',
  });
      ...
      <div className="bg-white min-h-screen">
        ...
        <div className="flex items-center justify-center py-32">
          <div className="text-center">
            <span className="material-icons text-5xl text-[#FF0000] mb-4">error_outline</span>
            <p className="font-manrope text-xl text-[#374151] mb-4">{error || 'Property not found'}</p>
            <Link
              to="/properties"
              className="bg-[#FF0000] text-white font-manrope font-bold px-8 py-3 rounded-lg hover:bg-[#B86851] transition-all inline-block"
            >
              Back to Properties
            </Link>
          </div>
