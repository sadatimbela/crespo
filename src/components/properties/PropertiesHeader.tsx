...
const PropertiesHeader: React.FC<PropertiesHeaderProps> = ({
  ...
  return (
    <div className="border-b border-[#E6E0DA] bg-white sticky top-0 z-10">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 py-4 md:py-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-white border border-[#E6E0DA] rounded-lg px-4 py-2 font-manrope text-sm text-[#221410] cursor-pointer focus:outline-none focus:border-[#FF0000] appearance-none pr-8 bg-no-repeat bg-right"
                style={{
