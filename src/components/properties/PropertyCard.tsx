    ...
    <Link to={`/property/${id}`} className="block">
      ...
      <div className="relative aspect-[340/240] overflow-hidden">
        ...
        >
          <span className={`material-icons text-xl transition-all ${
            isFavorite 
              ? 'text-[#FF0000]' 
              : 'text-[#6B7280] group-hover/fav:text-[#FF0000]'
          }`}>
      ...
      <div className="p-5">
        ...
        <div className="flex items-baseline gap-1 mb-2">
          <span className="font-space-mono font-bold text-xl text-[#FF0000]">
            ₹
          </span>
          <span className="font-space-mono font-bold text-2xl text-[#FF0000]">
            {price}
          </span>
        </div>
        ...
        <div className="flex items-center gap-1 mb-4">
          <span className="material-icons text-[#FF0000] text-sm">
            location_on
          </span>
        ...
        <button className="w-full mt-2 bg-transparent border border-[#FF0000] text-[#FF0000] font-manrope font-bold py-2 rounded-lg hover:bg-[#FF0000] hover:text-white transition-all">
          View Details
        </button>
      </div>
    </div>
