      ...
      <div className="max-w-[1280px] mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="lg:pt-16">
            {/* Label */}
            <div className="mb-6">
              <p className="font-space-mono text-xs text-[#FF0000] uppercase tracking-[2.4px]">
                Our Heritage
              </p>
            </div>
            ...
            <h2 className="mb-6">
              ...
              <span className="font-fraunces italic text-[40px] leading-[50px] text-[#FF0000] block">
            ...
            <div className="space-y-6 mb-8">
              <p className="font-manrope font-extralight text-base leading-[26px] text-[#4b5563]">
                Founded by architects and data scientists, Crespo Real Estate emerged from a
            ...
            {/* Blockquote */}
            <blockquote className="border-l-4 border-[#FF0000] pl-6 mb-8">
              <p className="font-fraunces italic text-2xl leading-8 text-[#FF0000]">
            ...
            <a 
              href="#team" 
              className="inline-flex items-center gap-2 border-b border-[#221410] pb-1 group hover:border-[#FF0000] transition-colors"
            >
              <span className="font-space-mono text-sm text-[#221410] group-hover:text-[#FF0000] transition-colors">
                Meet the Architects
              </span>

              <ArrowRight className="w-4 h-4 text-[#221410] group-hover:text-[#FF0000] transition-colors" />
            </a>
          </div>
        </div>
      </div>
