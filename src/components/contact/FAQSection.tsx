...
const FAQSection: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    ...
    {
      id: 3,
      question: "Can I list my property exclusively with Crespo Real Estate?",
      ...
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="text-center mb-16">
          <div className="flex justify-center mb-3">
            <span className="font-space-mono text-xs text-[#FF0000] uppercase tracking-widest">
              Help Center
            </span>
          </div>
          ...
          <p className="font-manrope text-lg text-[#4B5563] leading-relaxed max-w-[640px] mx-auto">
            ...
            partnering with Crespo Real Estate.
          </p>
        </div>
            ...
            >
              ...
              >
                ...
                <div className="w-8 h-8 bg-[#F9F7F2] border border-[#E6E0DA] rounded-full flex items-center justify-center flex-shrink-0">
                  <span className="font-syne font-bold text-sm text-[#FF0000]">
                ...
                <span className={`material-icons text-[#FF0000] transition-transform ${
        ...
        <div className="text-center mt-12">
          <a 
            href="#" 
            className="inline-flex items-center gap-2 font-manrope font-bold text-base text-[#FF0000] hover:text-[#C05621] transition-colors group"
          >
