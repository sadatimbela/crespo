      ...
      <div className="bg-white border border-[#E6E0DA] rounded-xl p-6">
        <div className="flex items-start gap-4">
          <div className="w-12 h-12 bg-[rgba(212,117,91,0.1)] rounded-full flex items-center justify-center flex-shrink-0">
            <span className="material-icons text-2xl text-[#FF0000]">
              location_on
            </span>
          </div>
          <div className="flex-1">
            ...
            <a 
              ...
              className="inline-flex items-center gap-1 font-manrope font-medium text-sm text-[#FF0000] hover:text-[#C05621] transition-colors"
            >
          ...
          <div className="flex-1">
            ...
            <div className="space-y-2">
              <a 
                ...
                className="flex items-center gap-2 font-manrope font-extralight text-sm text-[#4B5563] hover:text-[#FF0000] transition-colors"
              >
              ...
              <a 
                href="mailto:hello@Crespo Real Estate.com" 
                className="flex items-center gap-2 font-manrope font-extralight text-sm text-[#4B5563] hover:text-[#FF0000] transition-colors"
              >
                <span className="material-icons text-base">
                  email
                </span>
                <span>hello@Crespo Real Estate.com</span>
              </a>
            </div>
          </div>
        </div>
