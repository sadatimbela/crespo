...
const ContactFormCard: React.FC = () => {
  ...
  return (
    <div className="bg-white border border-[#E6E0DA] rounded-2xl p-5 sm:p-8 shadow-sm">
      {/* Card Header */}
      <div className="mb-8">
        <h2 className="font-syne font-bold text-xl sm:text-2xl text-[#221410] mb-2">
          Send Us a Message
        </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            rows={5}
            className="w-full bg-[#F5F1E8] border border-[#E6E0DA] rounded-lg px-4 py-3 font-manrope font-extralight text-sm text-[#0F172A] placeholder:text-[#94A3B8] focus:outline-none focus:border-[#FF0000] transition-colors resize-none"
            required
          />
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-[#FF0000] hover:bg-[#C05621] disabled:opacity-60 disabled:cursor-not-allowed text-white font-manrope font-bold text-base py-3.5 rounded-xl transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
        >
          {loading ? (
            <>
