          ...
          {methods.map((method, index) => (
            ...
            >
              ...
              <div className={`w-16 h-16 ${method.bgColor} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                <span className="material-icons text-3xl text-[#FF0000]">
                  {method.icon}
                </span>
              </div>
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 font-manrope font-bold text-sm text-[#FF0000] hover:text-[#C05621] transition-colors group"
              >
