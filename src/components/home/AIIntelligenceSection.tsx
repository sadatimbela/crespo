...
const AIIntelligenceSection: React.FC = () => {
  return (
    <section id="why-choose-us" className="bg-white py-10 md:py-24">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-8">
        {/* Section Header */}
        <div className="text-center mb-10 md:mb-16">
          <div className="font-space-mono text-sm text-primary uppercase tracking-widest mb-4">Why Choose Us?</div>
          <h2 className="font-inter font-bold text-2xl sm:text-3xl md:text-5xl text-[#111827] mb-4 md:mb-6">Redefining Real Estate</h2>
          <p className="font-manrope font-light text-base sm:text-lg text-[#4b5563] max-w-[740px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-white border border-[#f3f4f6] rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            <div className="w-14 h-14 bg-primary/10 rounded-xl flex items-center justify-center mb-6">
              <span className="font-material-icons text-3xl text-primary">verified</span>
            </div>
            <h3 className="font-syne font-bold text-xl text-[#111827] mb-4">Verified Opportunities</h3>
          ...
          <div className="bg-white border border-[#f3f4f6] rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="font-syne font-bold text-xl text-[#111827] mb-4">Professional Excellence</h3>
            <p className="font-manrope text-base text-[#6b7280] leading-relaxed">
          ...
          <div className="bg-white border border-[#f3f4f6] rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="font-syne font-bold text-xl text-[#111827] mb-4">Modernizing Tanzania</h3>
            <p className="font-manrope text-base text-[#6b7280] leading-relaxed">
