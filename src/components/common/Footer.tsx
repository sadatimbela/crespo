        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-3 mb-6">
              <img src={logoSrc} alt="Crespo Real Estate Ltd" className="h-12 w-auto brightness-0 invert" />
              <span className="font-inter text-xl font-bold">Crespo Real Estate Ltd</span>
            </Link>
            <p className="font-manrope font-extralight text-[#9ca3af] text-sm leading-relaxed mb-6">
              Leading luxury real estate platform in Tanzania connecting you with exclusive property opportunities through professional excellence and transparency.
            </p>
            {/* Social Links */}
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 bg-[rgba(255,255,255,0.05)] hover:bg-[#FF0000] border border-[rgba(255,255,255,0.1)] rounded-lg flex items-center justify-center transition-all group"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/signup" className="font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white hover:pl-2 transition-all inline-block">
                  Get Started
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/#why-choose-us" className="font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white hover:pl-2 transition-all inline-block">
                  Why Choose Us?
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-4">
              <li>
                <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-colors group">
                  <MapPin className="w-5 h-5 mt-0.5 flex-shrink-0 text-[#FF0000]" />
                  <span className="leading-relaxed">
                    Masaki Crescent,<br />
                    Plot 12, Haile Selassie Rd,<br />
                    Dar es Salaam, Tanzania
                  </span>
                </a>
              </li>
              <li>
                <a href="tel:+255700000000" className="flex items-center gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-colors">
                  <Phone className="w-5 h-5 flex-shrink-0 text-[#FF0000]" />
                  <span>+255 700 000 000</span>
                </a>
              </li>
              <li>
                <a href="mailto:info@cresporealestate.com" className="flex items-center gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-colors">
                  <Mail className="w-5 h-5 flex-shrink-0 text-[#FF0000]" />
                  <span>info@cresporealestate.com</span>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              <input
                ...
                className="w-full bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] rounded-lg px-4 py-3 font-manrope font-extralight text-sm text-white placeholder:text-[#6b7280] focus:outline-none focus:border-[#FF0000] transition-colors"
                required
              />
              <button
                type="submit"
                className="w-full bg-[#FF0000] hover:bg-[#C05621] text-white font-manrope font-bold text-sm px-4 py-3 rounded-lg transition-all shadow-lg hover:shadow-xl"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-[rgba(255,255,255,0.1)] pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="font-manrope font-extralight text-[#6b7280] text-sm text-center md:text-left">
              © 2026 Crespo Real Estate Ltd. All rights reserved.
            </p>
